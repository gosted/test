		...
		function setTable (data)
		{
			...
			$.each(list, function (i, v)
			{
				...
				STr.append('<td class="btns text-r">' +
					'<a style="text-decoration:none" class="mr-5 op" href="javascript:;" title="编辑" _href="system-user-edit.html">'+
					'<i class="Hui-iconfont">&#xe70c;</i></a>'+

					'<a style="text-decoration:none" class="mr-5 del" href="javascript:;" title="删除">'+
					'<i class="Hui-iconfont">&#xe6e2;</i></a>'+

					'<a style="text-decoration:none" class="mr-5 Administration" href="javascript:;" title="管理角色" _href="system-user-ASingleEditor.html">'+
					'<i class="Hui-iconfont">&#xe61d;</i></a>'+

					'<a style="text-decoration:none" class="mr-5 ModifyPassword" href="javascript:;" title="重置密码" _href="system-user-ModifyPassword.html">'+
					'<i class="Hui-iconfont">&#xe63f;</i></a>'+
					'</td>');
		...
		*/
		...
		$(".btn-batchAdd").on("click", function ()
		{
			...
			$(".tbody").find("input:checkbox:checked").each(function () {
				var objattr =  $(this).parent().parent("tr").attr("libid");
				var usernames = $(this).attr("username");
				usernameid.push(objattr);
			...
			if(checkedlist !=0){
				data.usernameid = usernameid.join();
				data.username = username.join();
				window.layerViewData = data;
				window.layerShow("批量添加角色","system-user-roleManagement.html");
			}
