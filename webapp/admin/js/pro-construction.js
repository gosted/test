	...
	$(function() {
		...
		function setTable (data)
		{
			...
			$.each(list, function (i, v)
			{
				...
				STr.append('<td style="text-align:left;cursor:pointer;" title="下载" class="down" attachment='+v.attachmentId+' class="td-view"><a class=" text-primary  href=javascript:;">' + v.planName + '</a></td>');
				...
				STr.append('<td class="btns">' +
					'<a style="text-decoration:none;position:relative;top:1px;" class="mr-5 op" href="javascript:;" title="编辑" _href="pro-construction-check.html">'+
		...
		{
			sessionStorage.setItem("constrcuctionType","1");
		...
		{
			var planName = $(".search-area").find(".planName").val();
			initTable ({pageSize: pageSize, pageNo: pageNo,planName:planName,workOrderId:projectId,type:"1"});
		}
