...
(function($, w, d) {
    ...
    $(function(){
        ...
        $.myAjax({
            type: "POST",
            url: window.ajaxUrl + "/project/workOrder/findApprovalWG",
            data: {workOrderId:id},
            success: function (data)
            {
                if (data && data.success === 0)
                {
                    ...
                    }else if(data.data.apprResult== 1){
                        $(".approval-result").text("同意");
                    }else{
                        $(".approval-result").text("");
                        $(".approver").prev().text("办理人：");
                        $(".approval-time").prev().text("办理时间：");
                        $(".approval-time").attr("colSpan","15");
                        $(".approver").attr("colSpan","15");
                        $(".approval-result").html("").hide();
                        $(".approval-result").prev().html("").hide();
                        $(".approval-opinion").html("").hide();
                        $(".approval-opinion").prev().html("").hide();
                    }
                }
            }
        });
