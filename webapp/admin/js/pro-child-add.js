	...
	$(function() {
		...
		$(".add-btn").on("click",function()
		{
			...
			Otr.append('<td class="text-c">'+
				'<a style="text-decoration:none" class="mr-5 btn-delete" href="javascript:;" title="删除">'+
		...
		$(".btns .add").on("click",function()
		{
			...
			tmpBtn += '<a style="text-decoration:none" class="mr-5 deal" href="javascript:;" title="编辑">'+
				'<i class="Hui-iconfont">&#xe70c;</i></a>';
		...
		$(".table-box").Validform({
			...
			beforeSubmit:function(curform){
				...
				sendData.projectId = parentProjectId;
				sendData.projectCode = projectCode;

				$.myAjax({
					type: "POST",
					url: window.ajaxUrl + "project/subProject/create",
					data: sendData,
					dataType: "json",
