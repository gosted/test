			...
			$.myAjax({
				...
				success: function(data)
				{
					if (data && data.success === 0)
					{
						...
						noIn.text(listData.outNum || "0").attr("title",listData.outNum || "");
						allIn.text(listData.detailCount || "0").attr("title",listData.detailCount || "");
						equVal.text(listData.ext1 || "").attr("title",(listData.ext1 || "") + "元");
						if (listData.outNum == 0)
						{
							noIn.removeClass("c-red");
						}
						allAbleStoreNum = listData.outNum;
						$('[con_name="storeCount"]').val(listData.outNum);
