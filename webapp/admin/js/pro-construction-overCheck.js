...
(function($, w, d){
    ...
    $(function() {
        ...
        $(".contract-box").find(".contractName").text(projectName);
        $(".contract-box").find(".site").text(site||"联通");
        $(".contract-box").find(".contractCode").text(workName);
        ...
        $.myAjax({
            ...
            success: function(msg)
            {
                if (msg && msg.success === 0)
                {
                    ...
                    {
                        var keyVal = _data[v];
                        $(".contract-box").find($('[con_name="' + v + '"]')).text(keyVal);
                    });
