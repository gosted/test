                ...
                success: function(data)
                {
                    if (data && data.success === 0)
                    {
                        ...
                        $(".project").on('change',function(){
                            ...
                            /*$(".equipment-cnt tbody").find(".apply").remove();
                             $(".server-cnt tbody").find(".apply").remove();
                             $(".other-cnt tbody").find(".apply").remove();*/
                ...
                success: function(data)
                {
                    if (data && data.success === 0)
                    {
                        ...
                        $(".relevant").on("click", function ()
                        {
                            ...
                            {
                                window.layerShow("工单","pro-order-list.html");
                            }
                            else
                            {
                                layer.msg("请选择子项目")
            ...
            beforeSubmit:function(curform){
                ...
                else
                {
                    ...
                    $("#roleAdd").each(function(i,o){
                        ...
                        hasObj.skipLeader = $('input[name="skipLeader"]:checked').val();
                    ...
                    var checkList = $(".checkbox").find(".msg");
