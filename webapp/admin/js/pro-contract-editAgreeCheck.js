...
(function ($, w, d) {
    ...
    $(function () {
            ...
            success: function (data) {
                if (data && data.success === 0) {
                   ...
                   if(contractType == "HTFL-XY"){
                        ...
                        getAttach($(".agree-box"),$(".upload-file1"),$("#upload1"));
        ...
        $(".agree-box").on("click",".del",function () {
            var _this = $(this);
        ...
        var  flagSave = true;
        $(".agree-box").on("click",".edit",function () { //点击编辑
