...
(function($, w, d) {
    ...
    $(function(){
        var pageSize = 1000,
            ...
            complainantId = parent.window.layerViewData.problemId,
        ...
        $("#table-box").Validform({
            ...
            beforeSubmit:function(curform){
                ...
                else
                {
                    ...
                    $.myAjax({
                        type: "POST",
                        url: window.ajaxUrl + "operation/problemTreatment/create",
                        data: sendData,
                        dataType: "json",
                        success:function(data)
                        {
        ...
        $.myAjax({
            type: "POST",
            url: window.ajaxUrl +"operation/problemTreatment/find",
