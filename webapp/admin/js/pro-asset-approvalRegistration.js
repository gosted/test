	...
	$(function() {
		...
		function setTable (data)
		{
			...
			$.each(list, function (i, v)
			{
				...
				tmpBtn += '<a style="text-decoration:none" class="ml-5 deal" href="javascript:;" title="查看" _href="pro-registration-check.html">'+
		...
		$(".pagination").on("click", "ul span", function ()
		{
			...
			var assetCategory = search.find('[con_name="assetCode"]').val();
			var assetName = search.find('[con_name="assetName"]').val();
			assetCategory ? sendData.assetCategory = assetCode : false;
			assetName ? sendData.assetName = assetName : false;
		...
		tbody.on("click", ".deal", function ()
		{
			...
			window.layerShow("查看","pro-registration-check.html");
		});
