...
(function($, w, d) {
    ...
    $(function(){
        ...
        function setTable (data)
        {
            ...
            $.each(list, function (i, v)
            {
                ...
                STr.append('<td class="btns">' +
                    ...
                    /*'<a style="text-decoration:none" class="mr-5 look" _href="cus-fault-remarks.html" title="故障备注">'+
                    '<i class="Hui-iconfont">&#xe6b3;</i></a>'+*/
        ...
        function initTable (obj)
        {
            $.myAjax({
                type: "POST",
                url: window.ajaxUrl+"operation/faultReporting/findPage",
        ...
        $(".tbody").on("click",".faultName",function(){
            ...
            data.state = state;
            window.layerViewData = data;
            window.layerShow("查看","cus-fault-edit.html");
            return false;
