...
(function($, w, d) {
    ...
    $(function(){
        ...
        $.myAjax({
            ...
            data: {workOrderBasisId:id},//传入工单id
            dataType: "json",
                            ...
                            success:function(data)
                            {
                                if(data.data && data.success === 0)
                                {
                                    ...
                                    $.each(deviceList,function(i,v)
                                    {
                                        ...
                                        STr.append('<td class="authName" title='+ v.detailRemark+'><input readonly="readonly" disabled="disabled" type="text" class="needChoose input-text widthChange" value="'+v.detailRemark+'"></td>');
                                        STr.append('<td class="authName" title='+ v.equipmentName+'><input readonly="readonly" disabled="disabled" type="text" class="needChoose input-text widthChange" value="'+v.equipmentName+'"></td>');
