    ...
    $(function(){
        ...
        $.myAjax({
            ...
            success:function(data)
            {
                ...
                $(".complaintTime").val(formatDates(data.data.complaintTime));
                ...
                $('[con_name="complaintPresentation"]').keyup();
        ...
        function getFormInfo (box)
        {
            ...
            sendData.workSiteId = $(".worksite option:selected").text();
            sendData.state = $(".state option:selected").text();
            sendData.subProjectId = $(".subProject option:selected").text();
            sendData.projectId = $(".project option:selected").text();
            sendData.problemLevel =$(".level option:selected").text();
            return sendData;
        }
