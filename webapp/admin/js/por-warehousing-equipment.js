    ...
    $(function() {
        ...
        function setTable (data)
        {
            ...
            $.each(list, function (i, v)
            {
                ...
                {
                    var noin = Number(v.detailCount)- Number(v.unStoreCount)
                    noInSpan.text(noin || "0");
                }
        ...
        setContractDetailList({contractId: sourceId,detailType:"QDLX-SB"});//渲染合同清单基本信息
        //主顺序
        ...
        function renderingPage (sendData)
        {
            $.myAjax({
                type: "POST",
                url: window.ajaxUrl + "operation/storedetail/findPageByWOId",
                data: sendData,
                success: function (data) {
                    if (data && data.success === 0) {
